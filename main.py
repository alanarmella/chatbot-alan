...
def config_user_groq():
    # Asegúrate de que "API_KEY" esté en tu archivo secrets.toml o en las configuraciones de Streamlit Cloud
    api_key = st.secrets["API_KEY"]  # Asegúrate de que "API_KEY" esté configurado correctamente
...
def main():
    ...
    clienteUsuario = config_user_groq()  # Obtiene la instancia de Groq con el API Key
    cache()
